...
*** Test Cases ***
CH-01 Verify "Tạo mới" successfully when clicking "Tạo mới" button
  [Tags]                @smoketest               @regression
  When Background Happy paths
  When Click on the previously created "Tên tham số" tree to delete
  Then User look message "Success" popup

CH-02 Verify edit successfully when clicking item
  [Tags]                @smoketest               @regression
  When Background Happy paths
  Then User look message "Success" popup
...
CH-03 Verify when Delete menu successfully
  [Tags]                @smoketest               @regression
  When Background Happy paths
  Then User look message "Success" popup
  When Click on the previously created "Tên tham số" tree to delete
...
CH-04 Verify "Tạo mới" unsuccessfully when leaving all fields blank
  [Tags]                @smoketest               @regression
...
CH-05 Verify "Tạo mới" unsuccessfully when leaving "Tên tham số" field
  [Tags]                @smoketest               @regression
  When Go to page create data
  When Enter "text" in "Giá trị tham số" with "_RANDOM_""
  When Enter "text" in "Nhóm" with "Test"
...
CH-06 Verify "Tạo mới" unsuccessfully when leaving "Giá trị tham số" field
  [Tags]                @smoketest               @regression
  When Go to page create data
  When Enter "test name" in "Tên tham số" with "_RANDOM_""
  When Enter "text" in "Nhóm" with "Test"
...
CH-08 Verify when creating menu unsuccessfully when clicking Notification of Content Check Management then clicking on add new button
  [Tags]                @smoketest               @regression
  When Background Happy paths
  When Click on the previously created "Tên tham số" tree to edit
  When Click "Tạo mới" button
...
CH-09 Verify when navigation unsuccessfully when editing navigation
  [Tags]                @smoketest               @regression
  When Background Happy paths
  When Click on the previously created "Tên tham số" tree to edit
